...
export interface Tab {
    id: string;
    title: string;
    type: 'scene' | 'static-mesh' | 'texture' | 'sound' | 'material' | 'material-editor' | 'level' | 'skeleton' | 'animation-sequence' | 'physics-asset' | 'skeletal-mesh' | 'editor-preferences' | 'project-settings' | 'plugin-manager' | 'content-browser' | 'console';
