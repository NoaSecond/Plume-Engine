...
const LerpNode = ({ data, selected }: NodeProps) => {
    ...
    return (
        ...
        >
            <div style={{ padding: '8px 12px', background: selected ? theme.colors.accent.primary + '20' : theme.colors.bg.tertiary, borderBottom: `1px solid ${theme.colors.border.default}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ fontSize: '14px', fontWeight: 500 }}>Lerp</div>
            </div>
            ...
            <div style={{ padding: '12px 0', position: 'relative' }}>
                <div style={{ position: 'relative', padding: '6px 16px', display: 'flex', alignItems: 'center', fontSize: '12px' }}>
                    <Handle type="target" position={Position.Left} id="a" style={{ width: '10px', height: '10px', background: theme.colors.text.secondary, left: '-5px' }} />
                    <span>A</span>
                </div>
                <div style={{ position: 'relative', padding: '6px 16px', display: 'flex', alignItems: 'center', fontSize: '12px' }}>
                    <Handle type="target" position={Position.Left} id="b" style={{ width: '10px', height: '10px', background: theme.colors.text.secondary, left: '-5px' }} />
                    <span>B</span>
                </div>
                <div style={{ position: 'relative', padding: '6px 16px', display: 'flex', alignItems: 'center', fontSize: '12px' }}>
                    <Handle type="target" position={Position.Left} id="t" style={{ width: '10px', height: '10px', background: theme.colors.text.secondary, left: '-5px' }} />
                    <span>Alpha (T)</span>
                </div>
