                    ...
                    Callback<ICoreWebView2CreateCoreWebView2ControllerCompletedHandler>(
                        [htmlPath](HRESULT result, ICoreWebView2Controller* controller) -> HRESULT {
                            ...
                            if (settings) {
                                ...
                                // afin que le frontend (React) puisse g├®rer `onContextMenu`
                            ...
                            // ├ëcouter les messages depuis le frontend
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    // Configurer la couleur du th├¿me pour le splash screen
    ...
    // Initialiser le syst├¿me de plugins
    ...
    // Initialiser tous les plugins activ├®s
    ...
    // Attendre que WebView2 se charge compl├¿tement
    ...
    // Afficher la fen├¬tre maximis├®e avec l'animation Windows
    ...
    while (!g_app.shouldClose) {
        ...
        // Mettre ├á jour tous les plugins
